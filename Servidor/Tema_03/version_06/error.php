...
// Activamos un manejador de errores
...
function manejaErrores($nivel, $mensaje, $fichero, $linea) {
    ...
    // Registramos el error en un archivo log personalizado
...
function manejaExcepciones(Throwable $ex) {
    ...
    // Guardamos el error en el log (siempre recomendable)
    error_log($mensaje, 3, "C:/xampp/apache/logs/gestor_usuarios_exceptions.log");

    // Mostramos un mensaje controlado al usuario
